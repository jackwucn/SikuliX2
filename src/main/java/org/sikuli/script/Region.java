...
public class Region {
  ...
  private static SXLog sxLog = SX.getSXLog("API.REGION");

  private static Element.eType eClazz = Element.eType.REGION;
  public Element.eType getType() {
    return eClazz;
  }
  ...
  private Element thisE = new Element();
  ...
  public boolean isValid() {
    boolean valid = true;
    valid &= SX.isNotNull(thisE.getScreen());
    valid &= thisE.w > 1 && thisE.h > 1;
    valid &= thisE.getScreen().asElement().contains(this.asElement());
    return valid;
  }
