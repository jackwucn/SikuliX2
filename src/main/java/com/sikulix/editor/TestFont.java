...
//    add(wrappedTable("using getFont, derived (float)", true, true, true));
  ...
  private JPanel wrappedTable(String title, boolean useGetFont, boolean deriveNewFont, boolean castToFloat) {
...
//    panel.setBorder(new TitledBorder(title));
  ...
  private JTable getTable(boolean useGetFont, boolean deriveNewFont, boolean castToFloat) {
...
//    CellRenderer cellRenderer = new CellRenderer(customFont, useGetFont, deriveNewFont, castToFloat);
...
//    }
  ...
  public static class CellRenderer extends DefaultTableCellRenderer {
    ...
    public CellRenderer(Font customFont, boolean overrideGetFont, boolean deriveNewFont, boolean castToFloat) {
